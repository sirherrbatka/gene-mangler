...
(defmethod generation:crossover-pairs/proxy ((population-interface/proxy directed)
                                             population-interface
                                             population)
  (cl-ds.alg:on-each (generation:population-range population-interface
                                                  population)
                     (~>> population directions first (curry #'cons))))


(defmethod process:update-population-after-cycle!/proxy (process/proxy
...
(defmethod process:finished-p/proxy (process/proxy
                                     (population-interface/proxy directed)
                                     proces
                                     population-interface
                                     population)
